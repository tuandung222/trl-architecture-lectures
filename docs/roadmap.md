...
Dưới đây là giáo trình tự học gồm 10 bài đi từ lý thuyết nền tảng đến chi tiết hiện thực và thực hành với `trl`.
...
* **[Bài 4b: RLOO Trainer - REINFORCE Leave-One-Out](lesson_4b_rloo_trainer)**
  * Leave-one-out baseline estimator: lower variance so với group mean.
  * Sequence-level loss vs token-level loss, KL penalty trừ vào reward.
  * So sánh RLOO vs GRPO vs PPO.
...
* **[Bài 6: Reward Engineering & Verification](lesson_6_reward_engineering)**
  ...
  * RewardTrainer: train reward model từ preference data.
  * Callbacks: SyncRefModelCallback, LogCompletionsCallback, BEMACallback.
